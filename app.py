...
def get_param_5level_rating(param, val):
    ...
    # 5 Bold Vector Face SVGs (High Contrast 100% PDF Compatible):
    SVG_GREEN  = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#22C55E" stroke="#16803C" stroke-width="6"/><circle cx="34" cy="44" r="9" fill="#000000"/><circle cx="66" cy="44" r="9" fill="#000000"/><path d="M28 58 Q50 84 72 58 Q68 78 50 78 Q32 78 28 58 Z" fill="#000000"/><path d="M32 60 Q50 72 68 60" stroke="#ffffff" stroke-width="4" fill="none" stroke-linecap="round"/></svg>'
    SVG_YELLOW = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#EAB308" stroke="#A5730A" stroke-width="6"/><circle cx="34" cy="44" r="9" fill="#000000"/><circle cx="66" cy="44" r="9" fill="#000000"/><path d="M30 62 Q50 78 70 62" stroke="#000000" stroke-width="9" fill="none" stroke-linecap="round"/></svg>'
    SVG_ORANGE = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#F97316" stroke="#B4530A" stroke-width="6"/><circle cx="34" cy="44" r="9" fill="#000000"/><circle cx="66" cy="44" r="9" fill="#000000"/><line x1="30" y1="64" x2="70" y2="64" stroke="#000000" stroke-width="9" stroke-linecap="round"/></svg>'
    SVG_RED    = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#EF4444" stroke="#9B1C1C" stroke-width="6"/><circle cx="34" cy="48" r="9" fill="#000000"/><circle cx="66" cy="48" r="9" fill="#000000"/><path d="M30 72 Q50 56 70 72" stroke="#000000" stroke-width="9" fill="none" stroke-linecap="round"/></svg>'
    SVG_PURPLE = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#9333EA" stroke="#5B1A8C" stroke-width="6"/><circle cx="34" cy="48" r="9" fill="#000000"/><circle cx="66" cy="48" r="9" fill="#000000"/><circle cx="50" cy="66" r="10" fill="#000000"/></svg>'
