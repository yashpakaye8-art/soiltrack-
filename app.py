...
def get_param_5level_rating(param, val):
    ...
    # 5 Crisp Vector SVGs with solid fills for 100% html2canvas PDF compatibility:
    SVG_GREEN = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#22C55E" stroke="#16803C" stroke-width="4"/><ellipse cx="38" cy="28" rx="20" ry="12" fill="#ffffff" opacity="0.28"/><circle cx="34" cy="46" r="5.5" fill="#1a1a1a"/><circle cx="66" cy="46" r="5.5" fill="#1a1a1a"/><path d="M30 60 Q50 82 70 60 Q68 76 50 76 Q32 76 30 60 Z" fill="#7A1F1F"/><path d="M33 61 Q50 72 67 61" stroke="#ffffff" stroke-width="4" fill="none" stroke-linecap="round"/></svg>'
    SVG_YELLOW = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#EAB308" stroke="#A5730A" stroke-width="4"/><ellipse cx="38" cy="28" rx="20" ry="12" fill="#ffffff" opacity="0.3"/><circle cx="34" cy="46" r="5" fill="#1a1a1a"/><circle cx="66" cy="46" r="5" fill="#1a1a1a"/><path d="M32 62 Q50 74 68 62" stroke="#1a1a1a" stroke-width="4.5" fill="none" stroke-linecap="round"/></svg>'
    SVG_ORANGE = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#F97316" stroke="#B4530A" stroke-width="4"/><ellipse cx="38" cy="28" rx="20" ry="12" fill="#ffffff" opacity="0.28"/><circle cx="34" cy="46" r="5" fill="#1a1a1a"/><circle cx="66" cy="46" r="5" fill="#1a1a1a"/><line x1="33" y1="65" x2="67" y2="65" stroke="#1a1a1a" stroke-width="4.5" stroke-linecap="round"/></svg>'
    SVG_RED = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#EF4444" stroke="#9B1C1C" stroke-width="4"/><ellipse cx="38" cy="28" rx="20" ry="12" fill="#ffffff" opacity="0.25"/><line x1="26" y1="38" x2="40" y2="44" stroke="#1a1a1a" stroke-width="4" stroke-linecap="round"/><line x1="74" y1="38" x2="60" y2="44" stroke="#1a1a1a" stroke-width="4" stroke-linecap="round"/><circle cx="34" cy="50" r="5" fill="#1a1a1a"/><circle cx="66" cy="50" r="5" fill="#1a1a1a"/><path d="M32 70 Q50 60 68 70 Q50 66 32 70 Z" fill="#1a1a1a"/></svg>'
    SVG_PURPLE = '<svg viewBox="0 0 100 100" width="100%" height="100%"><circle cx="50" cy="50" r="46" fill="#9333EA" stroke="#5B1A8C" stroke-width="4"/><ellipse cx="38" cy="28" rx="20" ry="12" fill="#ffffff" opacity="0.22"/><line x1="24" y1="40" x2="42" y2="47" stroke="#1a1a1a" stroke-width="4.5" stroke-linecap="round"/><line x1="76" y1="40" x2="58" y2="47" stroke="#1a1a1a" stroke-width="4.5" stroke-linecap="round"/><circle cx="34" cy="52" r="5.5" fill="#1a1a1a"/><circle cx="66" cy="52" r="5.5" fill="#1a1a1a"/><path d="M30 64 Q50 60 70 64 Q68 78 50 78 Q32 78 30 64 Z" fill="#1a1a1a"/><line x1="38" y1="66" x2="38" y2="73" stroke="#D8B4FE" stroke-width="2.5"/><line x1="46" y1="65" x2="46" y2="75" stroke="#D8B4FE" stroke-width="2.5"/><line x1="54" y1="65" x2="54" y2="75" stroke="#D8B4FE" stroke-width="2.5"/><line x1="62" y1="66" x2="62" y2="73" stroke="#D8B4FE" stroke-width="2.5"/></svg>'

    C_LOWER    = {'level': 'lower',    'label': 'LOWER',    'color': '#22C55E', 'bg': '#DCFCE7', 'border': '#16803C', 'style': 'background: #DCFCE7; border: 1.5px solid #16803C;', 'svg': SVG_GREEN}
    C_LOW      = {'level': 'low',      'label': 'LOW',      'color': '#EAB308', 'bg': '#FEF3C7', 'border': '#A5730A', 'style': 'background: #FEF3C7; border: 1.5px solid #A5730A;', 'svg': SVG_YELLOW}
    C_MODERATE = {'level': 'moderate', 'label': 'MODERATE', 'color': '#F97316', 'bg': '#FFEDD5', 'border': '#B4530A', 'style': 'background: #FFEDD5; border: 1.5px solid #B4530A;', 'svg': SVG_ORANGE}
    C_HIGH     = {'level': 'high',     'label': 'HIGH',     'color': '#EF4444', 'bg': '#FEE2E2', 'border': '#9B1C1C', 'style': 'background: #FEE2E2; border: 1.5px solid #9B1C1C;', 'svg': SVG_RED}
    C_HIGHER   = {'level': 'higher',   'label': 'HIGHER',   'color': '#9333EA', 'bg': '#F3E8FF', 'border': '#5B1A8C', 'style': 'background: #F3E8FF; border: 1.5px solid #5B1A8C;', 'svg': SVG_PURPLE}
